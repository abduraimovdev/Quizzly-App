...
import 'package:quizzly_math/services/data/database/quizzly.dart';
...
class IntroController {
  ...
  static void buttonLevelOne(BuildContext context) {
    Navigator.of(
      context,
    ).pushNamed(QuizScreen.id, arguments: QuizData.levelOne());
  ...
  static void buttonLevelTwo(BuildContext context) {
    Navigator.of(
      context,
    ).pushNamed(QuizScreen.id, arguments: QuizData.levelTwo());
  ...
  static void buttonLevelThree(BuildContext context) {
    Navigator.of(
      context,
    ).pushNamed(QuizScreen.id, arguments: QuizData.levelThree());
